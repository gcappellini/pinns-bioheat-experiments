...
def plot_loss_components(loss_train, loss_test, iters, nam):
    ...
    loss_res, loss_bc0, loss_ic = loss_train[:, 0], loss_train[:, 1], loss_train[:, 2]
    ...
    loss_terms = np.vstack((loss_res, loss_bc0, loss_ic, test, train))
    
    # Labels for the legend
    # legend_labels = [r'$\mathcal{L}_{res}$', r'$\mathcal{L}_{bc0}$', r'$\mathcal{L}_{bc1}$', r'$\mathcal{L}_{ic}$', 'test loss', 'train loss']
    legend_labels = [r'$\mathcal{L}_{res}$', r'$\mathcal{L}_{bc0}$', r'$\mathcal{L}_{ic}$', 'test loss', 'train loss']
