...
def fitness(w_1, w_2, w_3, w_4):
    global ITERATION
    # ITERATION: str="BEST"
    run_figs = set_run(output_dir, f"{ITERATION}")
            
    conf.model_properties.w_res = w_1
    conf.model_properties.w_bc0 = w_2
    conf.model_properties.w_bc1 = w_3
    conf.model_properties.w_ic = w_4
    ...
    iters_history[ITERATION] = {"w_res": w_1, "w_bc0": w_2, "w_bc1": w_3, "w_ic": w_4, "fitness": metr}
...
result = minimize(fitness, [w1_0, w2_0, w3_0, w4_0], bounds=bounds, method='L-BFGS-B', tol=1e-4)
