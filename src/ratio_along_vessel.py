...
temp_ratio_vessel1 = (temp_vessel1-Ttis)/(se.temperature_distribution(xr2, W1)-Ttis)
temp_ratio_vessel2 = (temp_vessel2-Ttis)/(se.temperature_distribution(xr2, W2)-Ttis)
temp_ratio_vessel3 = (temp_vessel3-Ttis)/(se.temperature_distribution(xr2, W3)-Ttis)
...
plt.ylabel(r'$\frac{T_{\text{fluid}}(y)-T_{\text{fluid}}(0)}{T_{\text{R2}}(0)-T_{\text{fluid}}(0)}$', fontsize=15)
...
plt.plot(y, Tr2(y, W1), label=f'w = {W1}')
plt.plot(y, Tr2(y, W2), label=f'w = {W2}')
plt.plot(y, Tr2(y, W3), label=f'w = {W3}')

plt.xlabel('y')
plt.ylabel('Tr2(y, w)')
plt.legend()
plt.title('Tr2(y, w) vs y for different values of w')
plt.show()